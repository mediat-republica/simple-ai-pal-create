  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-3">Historique des versions des textes juridiques</h3>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Suivi des modifications et évolutions des textes juridiques pour un meilleur contrôle législatif et réglementaire.
        </p>
      </div>
