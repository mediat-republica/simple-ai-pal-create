  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-3">Textes juridiques en attente de publication</h3>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Gérez et approuvez les textes juridiques soumis selon le workflow d'approbation
        </p>
      </div>
