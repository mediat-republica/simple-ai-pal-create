  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-3">Historique des versions des procédures</h3>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Suivi des modifications et évolutions des procédures administratives pour un meilleur contrôle des versions.
        </p>
      </div>
