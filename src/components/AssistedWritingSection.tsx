...
import { FileText, Users, CheckCircle, ArrowRight, PenTool } from 'lucide-react';

export function AssistedWritingSection() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {/* Document Models */}
      <div>
        <h2 className="text-xl font-semibold mb-4">Modèles de documents</h2>
